...
if argv[1]=='profile_toys':
    files = [
        ['CC_FxFx_Wplus_random_parametric_y2p00_qt32_default', 'W^{+}, toys, param-1D, |y| #leq 2.0, 30M'],
        ['CC_FxFx_Wplus_asimov_parametric_y2p00_qt32_default', 'W^{+}, asimov, param-1D, |y| #leq 2.0, 30M'],
        ]
    for v in [#'bias', 
              #'rms',
              'biasANDrms'
